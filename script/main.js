	...
	/*  Procédure ne prenant rien en argument et initialisant les différents boutons du site 
		...
		function init(){
			...
			buttonUpdate.addEventListener("click", onUpdate);  // La fonction updateTab se lance lorsque l'utilisateur clique sur le bouton Actualiser
